...
import { Briefcase, MapPin, Clock, DollarSign, Calendar, Users, X, Plus, CheckSquare, List, Edit3, ArrowLeft } from 'lucide-react';
...
const EditJobForm = () => {
        ...
        const fetchJobData = async () => {
            try {
                ...
                setFormData({
                    ...
                    expectedEndDate: job.expectedEndDate || job.endDate || '',
                    price: job.price || '',
                    negotiable: job.negotiable || (job.isNegotiable ? 'yes' : 'no'),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:3000/jobs/edit/${jobId}`, formData);
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="pt-6 flex gap-4">
                            <button
                                type="button"
                                onClick={() => navigate('/dashboard')}
                                className="flex-1 bg-gray-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                className="flex-1 bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                            >
                                Update Job
                            </button>
                        </div>
